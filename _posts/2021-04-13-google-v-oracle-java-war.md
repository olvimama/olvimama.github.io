...
예상한 것보다 몇 달의 시간이 지나고 드디어! 지난 4월 5일(미국 현지 시간 기준) 판결이 났습니다.
...
연방대법원은 최종 판결에서 "컴퓨터 프로그램은 원래부터 기능적(functional)이기 때문에 전통적인 저작권 개념을 적용하기가 어렵다"라고 말했다. (중략)
